...
import 'package:doctor_hunt/apps/features/common/auth_clean_arch/presentation/widgets/forgot_password_bottom_sheet.dart';
...
class _ForgotPasswordButton extends StatelessWidget {
  ...
  const _ForgotPasswordButton({required this.disabled});
...
class _SignUpFooter extends StatelessWidget {
  ...
  const _SignUpFooter({required this.disabled});
