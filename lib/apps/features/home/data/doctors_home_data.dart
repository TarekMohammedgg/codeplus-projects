...
List<LiveDoctorItem> liveDoctors(Translations t) => [
  LiveDoctorItem(
    id: 'live_1',
    name: 'Dr. Stephanie',
...
List<DoctorCategoryItem> categories(Translations t) => [
  DoctorCategoryItem(
    id: 'cat_dental',
    name: t.dental,
...
List<PopularDoctorItem> popularDoctors(Translations t) => [
  PopularDoctorItem(
    id: 'pop_1',
...
List<FeaturedDoctorItem> featuredDoctors(Translations t) => [
  FeaturedDoctorItem(
    id: 'feat_1',
    name: 'Dr. Cric',
